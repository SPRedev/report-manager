<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('fourniseurs.create') }}"
                ...
                @foreach ($fourniseurs as $fourniseur)
                    <tr class="border-t hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 flex space-x-2">
                            <a href="{{ route('fourniseurs.edit', $fourniseur) }}"
                            ...
                            <form action="{{ route('fourniseurs.destroy', $fourniseur->id) }}" method="POST"
                                onsubmit="return confirm('Are you sure you want to delete this fourniseur?')">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
