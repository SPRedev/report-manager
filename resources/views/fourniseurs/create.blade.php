<x-app-layout>
    ...
    <div class="p-6 max-w-3xl mx-auto bg-white shadow-md rounded-lg mt-6">
        <form method="POST" action="{{ route('fourniseurs.store') }}" class="space-y-6">
            @csrf

            <div>
                <x-input-label for="fourniseur_name" value="Name" />
                <x-text-input id="fourniseur_name" name="fourniseur_name" class="mt-1 block w-full" required />
            ...
            <div class="flex justify-end">
                <x-primary-button>Add fourniseur</x-primary-button>
            </div>
        </form>
    </div>
</x-app-layout>
