<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('clients.create') }}" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg text-sm shadow">
                + Add Client
            </a>
        </div>
    </x-slot>
                ...
                @foreach($clients as $client)
                    <tr class="border-t hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 flex space-x-2">
                            <a href="{{ route('clients.edit', $client) }}" class="text-yellow-600 hover:text-yellow-800 font-medium">Edit</a>
